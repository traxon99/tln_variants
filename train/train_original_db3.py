...
if __name__ == '__main__':
    ...
    def read_ros2_bag(bag_path):
        ...
        while reader.has_next():
            ...
            if topic == 'scan' or topic == 'Lidar':
                ...
                lidar_data.append(msg.ranges[::DOWNSAMPLE_FACTOR])
                # timestamps.append(t)
                ...
                if msg.drive.speed > bag_max_speed:
                    bag_max_speed = msg.drive.speed
    ...
    for pth in dataset_path:
        ...
        # speed_data = []
        bag_max_speed = 0
        lidar_data, servo_data, speed_data, bag_max_speed = read_ros2_bag(pth)

        print(f"{pth}: BAG MAX SPEED: {bag_max_speed}")
        if bag_max_speed > max_speed:
            max_speed = bag_max_speed
    ...
    test_speed = (test_speed - min_speed) / (max_speed - min_speed)
