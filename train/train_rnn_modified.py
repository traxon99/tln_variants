...
#========================================================
def create_lidar_sequences(lidar_data, servo_data, speed_data, sequence_length=5):
    """
    Build sliding-window sequences of LiDAR frames
    ...
    for i in range(len(lidar_data) - sequence_length):
        ...
        X.append(frames[..., None])  # shape becomes (seq_len, num_ranges, 1)
...
if __name__ == '__main__':
    ...
    # Build sequences
    X, y = create_lidar_sequences(all_lidar, all_servo, all_speed)
    print(X.shape)
    n_samples, seq_len, num_ranges, _ = X.shape
